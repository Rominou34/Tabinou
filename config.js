var config = {
  ...
  'news_count': 6, // The number of news displayed
  'follow_watch': true, // If you want to display 'watch' events in your news
  'follow_create': true // If you want to display 'create' events in your news
}
